...
I’m using http://www.w3.org/TR/xinclude/[XInclude] to split long XML files into smaller parts. Basically, it allows you to write things like this :
