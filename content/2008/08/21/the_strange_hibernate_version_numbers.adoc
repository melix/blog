...
If you are used to Maven, then you must have been annoyed with it, as the http://repo1.maven.org/maven2/org/hibernate/hibernate/[resulting artifacts never follow the same conventions] (with or without dash, uppercase or not, …).
