...
In this alternative example (suggested by http://twitter.com/#!/hansamann/status/68676573552852992[Sven Haiges]), we will prevent the user from calling _System.exit()_ :
