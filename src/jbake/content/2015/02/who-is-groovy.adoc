...
:regina: http://www.manning.com/koenig2/
:eos: http://blog.pivotal.io/pivotal/news-2/groovy-2-4-and-grails-3-0-to-be-last-major-releases-under-pivotal-sponsorship
:codehaus: http://www.codehaus.org/
:guillaume-restlet: http://restlet.com/blog/2015/03/02/head-of-groovy-project-joins-restlet-to-lead-api-development-tools/
:groovy-gh: https://github.com/groovy/groovy-core/
:groovy-asf: http://glaforge.appspot.com/article/groovy-projects-intends-to-join-the-apache-software-foundation
:icons: font
...
I got paid to work on Groovy so thank you Danno!
...
framework which http://groovy.329449.n5.nabble.com/Ann-Spock-1-0-has-been-released-td5722915.html[just reached 1.0]!

*Hamlet D'Arcy contributed a lot in terms of code quality*, but also became the first specialist of AST transformations. Andrés Almiray,
...
actively developed. 2009 is also the year I started to use Groovy, as a user. I never stopped and actually I started contributing back
...
In February 2013, we also launched a new big project: the documentation and website overhaul. It is incredible to think that this effort is still uncomplete, but if you see that the old wiki has more than a thousand page or contents (often outdated), you can imagine what effort it takes to rewrite the documentation. Hopefully, we're close to filling the gap now, and with the demise of Codehaus, we officially launched our http://groovy-lang.org[new website] where you can see the result of this job.
