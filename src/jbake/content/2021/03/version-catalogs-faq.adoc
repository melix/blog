...
The settings API is great as soon as you want to implement _settings plugins_ or, for example, that you want to use your own, existing format to declare a catalog, instead of using the TOML format.
