...
My daily job is working on the https://gradle.org[Gradle build tool]. However, I also published several projects on https://github.com/melix?tab=repositories[GitHub] you might be interested in.
