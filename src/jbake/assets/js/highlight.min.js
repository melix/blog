...
;hljs.registerLanguage("go",e)})();/*! `ruby` grammar compiled for Highlight.js 11.4.0 */
...
aliases:["yml"],contains:b}}})();hljs.registerLanguage("yaml",e)})();/*! `properties` grammar compiled for Highlight.js 11.4.0 */
(()=>{var e=(()=>{"use strict";return e=>{
...
;hljs.registerLanguage("properties",e)})();/*! `bash` grammar compiled for Highlight.js 11.4.0 */
...
illegal:/#|<\//}}})();hljs.registerLanguage("groovy",e)})();/*! `java` grammar compiled for Highlight.js 11.4.0 */
(()=>{var e=(()=>{"use strict"
...
;hljs.registerLanguage("python",e)})();/*! `gradle` grammar compiled for Highlight.js 11.4.0 */
...
})})();hljs.registerLanguage("gradle",e)})();/*! `rust` grammar compiled for Highlight.js 11.4.0 */
...
end:"$",illegal:"\n"},o]}}})();hljs.registerLanguage("kotlin",e)})();/*! `plaintext` grammar compiled for Highlight.js 11.4.0 */
